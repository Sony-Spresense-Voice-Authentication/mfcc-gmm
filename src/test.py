...
def train():
    ...
    ous50 = [
        f'{BASEPATH}/../audio/ous501.wav',
        f'{BASEPATH}/../audio/ous502.wav',
        f'{BASEPATH}/../audio/ous503.wav',
        f'{BASEPATH}/../audio/ous504.wav',
        f'{BASEPATH}/../audio/ous505.wav',
        f'{BASEPATH}/../audio/ous506.wav',
    ]

    success = voice_auth.build_model("ous50", ous50)
